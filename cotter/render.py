...
<h2>Results</h2>
{cards}
<footer>Generated by Cotter &middot; report schema v{version}. The open engine emits the evidence; the compliance layer renders the certified technical file.</footer>
</div>
</body>
</html>
"""
